                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="proses_login.php">
                                        ...
                                        <div class="form-group">
                                            <div class="g-recaptcha" data-sitekey="6LdJSvEpAAAAAEWN2imDDED0OM9BjKlvNUKpT6zk"></div>
                                        </div>
                                        <button type="submit" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </button>
                                       <a href="register.php" class="btn btn-facebook btn-user btn-block">
                                            <i class="fa fa-arrow-left"></i> Anda belum mempunyai akun? Silahkan registrasi dahulu !</a>
                                    </form>
                                    <hr>
